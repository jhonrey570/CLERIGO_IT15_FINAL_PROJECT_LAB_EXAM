...
import { SkeletonBlock, POSCardSkeleton } from '../common/Skeleton';
...
const CartPanel = ({ cartItems, updateQuantity, removeFromCart, clearCart, total, error, submitting, handleSubmitOrder }) => (
  <>
    ...
    return (
      <Layout title="Point of Sale">
        <div className="flex h-full overflow-hidden">
          ...
          <div className="hidden md:block w-80 bg-white shadow-lg border-l border-gray-100 shrink-0" />
        </div>
      </Layout>
    );
  }
